...
class Messenger extends React.Component {
            ...
            .then((response) => {
                if (response.status === 200){
                    ...
                    const contacts = results.map((result, index) =>
                         <React.Fragment>
                            <ListGroup as={"li"} className={(index===0) ? "contact is_active": "contact" } onClick={()=> this.isActive(result.subscriber.user.id)}>
    ...
    loadMessages =(chat_room)=>{
        if (chat_room ==="E") {
            ...
            this.setState({messages: <h2><br/><br/>Click on a Subscriber</h2>});
    ...
    // Now send the message throught the backend API
        ...
        addResponseMessage('Ok awesome chat!');
  };
                            ...
                            <Card style={{height: "750px"}}>
                                ...
                                <CardFooter>
                                    <InputGroup>
                                       ...
                                       <Input type="textarea" name="" className="form-control type_msg" placeholder="Type your message...">
